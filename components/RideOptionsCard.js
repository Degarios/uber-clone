  ...
  return (
    <SafeAreaView style={ tw`bg-white flex-grow justify-evenly` }> 
      <View>
        ...
        <Text style={ tw`text-center py-5 text-xl` }>Select a Ride - { travelTimeInfromation?.distance?.text }</Text>
      </View>
        ...
        renderItem={ ({ item: { id, title, multiplier, image }, item }) => (
            ...
            >
                ...
                <View style={ tw`-ml-6` }>
                    ...
                    <Text>{ travelTimeInfromation?.duration?.text } Travel time...</Text>
                </View>
                <Text style={ tw`text-xl` }>
                    {
                        ...
                        .format(99 /* ( travelTimeInfromation?.duration.value * SURGE_cHARGE_RATE * multiplier ) / 100 */)
                    }
                </Text>
            </TouchableOpacity>
        ) }
